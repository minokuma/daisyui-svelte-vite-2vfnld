...
<div class="sticky top-0 flex  items-center justify-center">
  <div class="box w-screen w-full flex flex-col items-center bg-white">
    ...
    <!-- 푸터 시작 -->
    <footer class="relative px-6 py-10 footer {$isDarkMode ? "bg-zinc-700": "bg-zinc-100" }">
      <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0 md:ml-70">
        ...
        <div class="md:flex md:gap-4 grid grid-flow-col gap-4">
          <a>
